export const stores: Record<string, Record<string, string>> = {
  columbus: {
  ...
  cincinnati: {
    url: "https://dam.flippenterprise.net/flyerkit/store/krogercincinnati?locale=en&access_token=4ebbe912b7d842dfcb6eee6417022d95&store_code=00390",
    path: "oh/cincinatti",
  },
  houston: {
  ...
  flowood: {
    ...
    path: "ms/flowood",
    info: "Mississippi, Arkansas, Missouri",
  },
  michigan: {
