export const stores: Record<string, Record<string, string>> = {
  flowood: {
    ...
    path: "ms/flowood",
    notes: "Mississippi, Arkansas, Missouri",
    zone: "Mississippi",
  },
  dallas: {
  ...
  houston: {
    ...
    path: "tx/houston",
    notes: "Includes up to Lake Charles",
    zone: "Houston",
  },
  kentucky: {
  ...
  virginia: {
    ...
    path: "va/richmond",
    notes: "Virginia, West Virginia, East Kentucky",
    zone: "Virginia",
  },
  atlanta: {
